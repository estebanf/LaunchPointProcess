...
-- Generated 11/12/17 9:53 AM
-- Descriptor: Metrics/metrics.xvar (currently edited)
-- External variable IQLetterTracking
DROP TABLE IF EXISTS IQLetterTracking;
CREATE TABLE IQLetterTracking (PID INTEGER, LETTERNUMBER INTEGER, CASEID VARCHAR(250), IQENQUEUED BOOLEAN, IQENQUEUEDAT VARCHAR(250), IQSENT BOOLEAN, IQSENTAT VARCHAR(250), IQRESPONSERECEIVED BOOLEAN, IQRESPONSERECEIVEDAT VARCHAR(250), IQRESPONSE VARCHAR(250), PPID VARCHAR(250), CREATEDAT TIMESTAMP, MODIFIEDAT TIMESTAMP);
CREATE INDEX IQLetterTracking_KEYS ON IQLetterTracking (PID, LETTERNUMBER);
...
CREATE TABLE CaseTracking (PID INTEGER, CASEID INTEGER, ISOINDICATOR INTEGER, SCORE INTEGER, ACCIDENTDATE TIMESTAMP, BENEFITAMOUNT INTEGER, FUNDINGSOURCE VARCHAR(250), LOB VARCHAR(250), STATE VARCHAR(250), WORKCOMP VARCHAR(250), CASESTATUS VARCHAR(250), CASESOURCE VARCHAR(250), CASETYPE VARCHAR(250), BATCHID INTEGER, CASERECEIVED BOOLEAN, CASEIDENTIFIED BOOLEAN, CASERECEIVEDAT TIMESTAMP, CASEIDENTIFIEDAT TIMESTAMP, PDID VARCHAR(250), CREATEDAT TIMESTAMP, MODIFIEDAT TIMESTAMP);
