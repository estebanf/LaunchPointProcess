...
CREATE TABLE IQTracking (PID INTEGER, CASEID INTEGER, PARENTID VARCHAR(250), IQRECEIVED BOOLEAN, IQRECEIVEDAT TIMESTAMP, IQHOLD VARCHAR(250), IQHOLDAT TIMESTAMP, IQCOMPLETED VARCHAR(250), IQCOMPLETEDAT TIMESTAMP, CREATEDAT TIMESTAMP, MODIFIEDAT TIMESTAMP, PDID VARCHAR(250));
