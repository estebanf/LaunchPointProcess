...
CREATE TABLE ISOTracking (CASEID INTEGER, BATCHID INTEGER, CLIENTID INTEGER, ENVIRONMENTID VARCHAR(250), REQUESTID VARCHAR(250), ISORECEIVED BOOLEAN, ISOPROCESSINGBEGAN BOOLEAN, ISODUPLICATEFOUND BOOLEAN, ISODATAFETCHED BOOLEAN, ISOSENT BOOLEAN, ISORECEIVEDAT TIMESTAMP, ISOPROCESSINGBEGANAT TIMESTAMP, ISODUPLICATEFOUNDAT TIMESTAMP, ISODATAFETCHEDAT TIMESTAMP, ISOSENTAT TIMESTAMP, PARENTPID INTEGER, PID INTEGER, PDID VARCHAR(250), CREATEDAT TIMESTAMP, MODIFIEDAT TIMESTAMP);
