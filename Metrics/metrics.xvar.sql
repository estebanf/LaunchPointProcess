...
CREATE TABLE IQTracking (PID INTEGER, BATCHID INTEGER, CASEID INTEGER, PARENTID VARCHAR(250), IQRECEIVED BOOLEAN, IQRECEIVEDAT TIMESTAMP, IQHOLD BOOLEAN, IQHOLDAT TIMESTAMP, IQCOMPLETED BOOLEAN, IQCOMPLETEDAT TIMESTAMP, KEYEMPLOYEE BOOLEAN, INVALIDADDRESS BOOLEAN, CREATEDAT TIMESTAMP, MODIFIEDAT TIMESTAMP, PDID VARCHAR(250));
