...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	version="2.0"
	xmlns:sendToISO-process="http://bpms.everteam.com/Processes/Integrations/sendToISO/process"
	...
	xmlns:ISO="http://bpms.everteam.com/Processes/Core/ProcessISOCase/ISO"
	...
	xmlns:tns="http://everteam.com/xvar/example" xmlns:DCM="http://bpms.everteam.com/Processes/Core/ProcessISOCase/DCM"
	...
	xmlns:iso="http://tempuri.org/"
	xmlns:this="http://bpms.everteam.com/Processes/Core/ProcessISOCase/Process_ISO_Case">
	<!--XSL Skeleton generated on Sun Dec 10 23:07:01 EST 2017 for F/LaunchPointProcess/Processes/Core/ProcessISOCase.bpm 
		pool:Process ISO Case activity: Extract RqUID Complete doXslTransform: bpel:doXslTransform("../../XSLT/ExtractRqUID.xsl", 
		$thisReceive_ISO_ACKRequest1Msg.body) Input document as defined in the mapper: 
		$thisReceive_ISO_ACKRequest1Msg.body -->
	<xsl:output />
	...
	<xsl:template match="/this:Receive_ISO_ACKRequest">
		<Launchpoint:RqUID>
			<Launchpoint:value>
				<xsl:value-of
					select="Launchpoint:content/iso:SubmitToISOResult/iso:ACORD/iso:ClaimsSvcRs/iso:RqUID" />
			</Launchpoint:value>
		</Launchpoint:RqUID>
	</xsl:template>
</xsl:stylesheet>
