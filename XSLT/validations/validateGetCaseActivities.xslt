...
<!--     </xsl:variable> -->
    ...
    <!--ActivityType-->
    <xsl:variable name="chkActivityType">
      <xsl:choose>
        <xsl:when test="ActivityType">
          <xsl:call-template name="validator">
            <xsl:with-param name="obj" select="ActivityType"/>
            <xsl:with-param name="dataType" select="'string'"/>
          </xsl:call-template>
        </xsl:when>
        <xsl:otherwise>false</xsl:otherwise>
    ...
    <!--ActivityCode-->
    <xsl:variable name="chkActivityCode">
      <xsl:choose>
        <xsl:when test="ActivityCode">
          <xsl:call-template name="validator">
            <xsl:with-param name="obj" select="ActivityCode"/>
            <xsl:with-param name="dataType" select="'string'"/>
          </xsl:call-template>
        </xsl:when>
        <xsl:otherwise>false</xsl:otherwise>
...
<!--         </xsl:when> -->
        ...
        <xsl:when test="$chkActivityType='false'">
          <Validation:isValid>false</Validation:isValid>
          <Validation:element>ActivityType</Validation:element>
        </xsl:when>
        <xsl:when test="$chkActivityCode='false'">
          <Validation:isValid>false</Validation:isValid>
          <Validation:element>ActivityCode</Validation:element>
        </xsl:when>
